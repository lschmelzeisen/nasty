...
class JsonSerializable:
    ...
    @classmethod
    @abstractmethod
    def from_json(cls: Type[TJsonSerializable], obj: Mapping[str, object]) \
            -> TJsonSerializable:
        raise NotImplementedError()


TJsonSerializableEnum = TypeVar('TJsonSerializableEnum',
                                bound='JsonSerializableEnum')
...
class JsonSerializableEnum(JsonSerializable, Enum):
    ...
    @final
    @overrides
    def from_json(cls: Type[TJsonSerializableEnum], obj: Mapping[str, object]) \
            -> TJsonSerializableEnum:
...
class JsonSerializedException(JsonSerializable):
    ...
    @overrides
    def to_json(self) -> Mapping[str, object]:
        return {'time': self.time.strftime(NASTY_DATE_TIME_FORMAT),
                'type': self.type,
    ...
    def from_json(cls, obj: Mapping[str, object]) -> 'JsonSerializedException':
        return cls(time=datetime.strptime(checked_cast(str, obj['time']),
