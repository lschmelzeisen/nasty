...
def test_1142944425502543875() -> None:
    ...
    assert datetime(year=2019, month=6, day=23,
                    hour=23, minute=56, second=0,
                    tzinfo=timezone.utc) == tweet.created_at
    assert '1142944425502543875' == tweet.id
    assert 'It is obvious that Mr. Trump is a terrible judge of character. ' \
           'His nominees for various high level cabinet positions have been ' \
           'unqualified, unforthcoming, or engaged in behavior unbecoming of ' \
           'a public servant. His standards should not be our standards. ' \
           'https://t.co/CHuQqFs5EX' == tweet.text
    assert 'https://twitter.com/TomSteyer/status/1142944425502543875' \
           == tweet.url
