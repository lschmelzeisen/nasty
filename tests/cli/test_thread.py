...
def _make_args(request: Thread, to_executor: Optional[Path] = None) -> Sequence[str]:
...
def test_correct_call_to_executor(
    request_: Thread, capsys: CaptureFixture, tmp_path: Path,
) -> None:
...
def test_correct_call_to_executor_exists(
    ...
    old_request = Thread("1024287257975566338")
    new_request = Thread("332308211321425920")
